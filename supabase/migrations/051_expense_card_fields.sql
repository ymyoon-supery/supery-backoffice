-- Add card_company and card_number columns for personal card evidence (VAT reporting)
ALTER TABLE expense_reports
  ADD COLUMN IF NOT EXISTS card_company TEXT,
  ADD COLUMN IF NOT EXISTS card_number  TEXT;

-- Recreate RPC with new card fields
...
BEGIN
  ...
  INSERT INTO expense_reports (
    ...
    tax_type, evidence_type, expense_type, card_company, card_number
  ) VALUES (
    ...
    p_tax_type, p_evidence_type, p_expense_type, p_card_company, p_card_number
