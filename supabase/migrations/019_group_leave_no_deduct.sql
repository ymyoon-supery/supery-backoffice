-- 공동연차(GROUP)는 회사 지정 휴일로 개인 연차 차감 대상에서 제외
...
BEGIN
  ...
  -- ANNUAL, HALF_DAY, AM_HALF, PM_HALF 만 잔여 연차에서 차감 (GROUP, COMP, SICK, OTHER 제외)
  IF p_leave_type IN ('ANNUAL', 'HALF_DAY', 'AM_HALF', 'PM_HALF') THEN
